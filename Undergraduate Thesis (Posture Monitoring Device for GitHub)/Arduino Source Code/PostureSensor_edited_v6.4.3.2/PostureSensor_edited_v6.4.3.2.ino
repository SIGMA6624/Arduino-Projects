...
/*int bendForward=80; //for gameMode
 int bendSuperForward = 60;
 int bendSide=40;
 int bendSuperSide = 20;*/
...
void setup(){
  ...
  accelgyro.setYAccelOffset(794);
  accelgyro.setZAccelOffset(724);
  ...
  if(calibrated == 0){        // posture deviation initialization
    ...
    while(true){
      ...
      if (receiveByte == 'a'){
        ...
        /*btSerial.print("goodAcX: ");  //averaged bad forward raw readings
         btSerial.print(goodAcX);
         btSerial.print(" || goodAcY: ");
         btSerial.print(goodAcY);
         btSerial.print(" || goodAcZ: ");
         btSerial.println(goodAcZ);*/
    ...
    while(true){
      ...
      if (receiveByte == 'a'){
        ...
        /*btSerial.print("badFAcX: ");  //averaged bad forward raw readings
         btSerial.print(badFAcX);
         btSerial.print(" || badFAcY: ");
         btSerial.print(badFAcY);
         btSerial.print(" || badFAcZ: ");
         btSerial.println(badFAcZ);*/
        break;
      }
      delay(333);
    }
    /*while(true){
      btSerial.println("Lean backward to bad posture, then send 'a'.");
      if (btSerial.available()){
        //accelgyro.getAcceleration(&goodAcX, &goodAcY, &goodAcZ);
        receiveByte = btSerial.read();
      }
      if (receiveByte == 'a'){
        ...
        badBAcZ = badBAcZ/10;
*/
        /*btSerial.print("badBAcX: ");           //averaged bad backward raw readings
         btSerial.print(badBAcX);
         btSerial.print(" || badBAcY: ");
         btSerial.print(badBAcY);
         btSerial.print(" || badBAcZ: ");
         btSerial.println(badBAcZ);*/
  /*      break;
      }
      delay(333);
    }*/
    ...
    /*btSerial.print("gwrtX: ");
     btSerial.print(gwrtX);
     btSerial.print(" || gwrtY: ");
     btSerial.print(gwrtY);
     btSerial.print(" || gwrtZ: ");
     btSerial.println(gwrtZ);*/
    ...
    /*btSerial.print("bfwrtX: ");
     btSerial.print(bfwrtX);
     btSerial.print(" || bfwrtY: ");
     btSerial.print(bfwrtY);
     btSerial.print(" || bfwrtZ: ");
     btSerial.println(bfwrtZ);*/
    ...
    /*btSerial.print("bbwrtX: ");
     btSerial.print(bbwrtX);
     btSerial.print(" || bbwrtY: ");
     btSerial.print(bbwrtY);
     btSerial.print(" || bbwrtZ: ");
     btSerial.println(bbwrtZ);*/
    ...
    /*btSerial.print("devfwrtX: ");
     btSerial.print(devfwrtX);
     btSerial.print(" || devfwrtY: ");
     btSerial.print(devfwrtY);
     btSerial.print(" || devfwrtZ: ");
     btSerial.println(devfwrtZ);*/
    ...
    /*btSerial.print("devbwrtX: ");
     btSerial.print(devbwrtX);
     btSerial.print(" || devbwrtY: ");
     btSerial.print(devbwrtY);
     btSerial.print(" || devbwrtZ: ");
     btSerial.println(devbwrtZ);*/
  ...
  btSerial.println("PostureSensor_edited_v6.4.3.1");
}
    ...
    if(receiveByte == 'c'){
      ...
      if(game == LOW){
        ...
        if(buttonState == HIGH){
          ...
          /*btSerial.print("yBasePos: ");
           btSerial.print(yBasePos);
           btSerial.print(", pThreshX: ");
           btSerial.println(pThreshX);
           btSerial.print(", nThreshX: ");
           btSerial.println(nThreshX);*/
          ...
          if((wrtZ >= pThreshZ) || ((wrtZ < nThreshZ)) || (wrtX >= pThreshX) || (wrtX < nThreshX)){
            ...
            //btSerial.print(",");
            //btSerial.print(inactivityCtr);    //print time the user remained in good posture after bad posture
